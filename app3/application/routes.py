...
def answer():
  ...
  # anwsers = { "A" : "Well, duh", "B" : "Yes, if you leave me alone..", "C" : "You wish", "D" : "So now you need my help...?", "E" : "You call that a question?", "F" : "Trump uses me when he decides to go to war", "G" : "Pluto says no and that he's still a planet", "H" : "Ask me when I care", "I": "Get a life", "I" : "You shouldn't use me to make your life decisions.." }
    return jsonify({'key2':anwsers})
